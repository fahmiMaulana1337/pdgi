    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('updateAkun',$data->id) }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="npa" class="col-md-4 col-form-label text-md-end">{{ __('npa') }}</label>

                            <div class="col-md-6">
                                <input id="npa" type="text" value="{{ $data->npa }}" class="form-control @error('npa') is-invalid @enderror" name="npa">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="foto" type="file" class="form-control @error('foto') is-invalid @enderror" name="foto" value="{{ $data->foto}}" required autocomplete="foto" autofocus>
